...
function DashboardPage({ products, productsError, productsLoading, dashboardSummary, dashboardLoading, occupiedTables, totalTables, onNavigate, onRetryProducts, canManageProducts }) {
  const stats = [
